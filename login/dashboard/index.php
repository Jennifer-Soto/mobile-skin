...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- End of Sidebar -->
        <center><img src="../../images/logos/funda-mobile.svg" alt="centered image" height="598" width="900"> </center>
        <!-- Content Wrapper -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">¿Seguro que quieres cerrar session?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Seleccione "cerrar" para salir</div>
