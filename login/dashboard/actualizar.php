...
if(isset($_POST['actualizar'])){
    ...
    $update=mysqli_query($mysqli, "UPDATE funda_celular SET color='$color', img='$img', modelo='$modelo' WHERE id_funda=$nik");
  /*   if($update){
        echo"dato guardado";
    }else{
...
<form action="" method="post" class="form-style">             
                ...
                <input type="text" class="form-control" placeholder = "ingrese el color" name="color" value="<?php echo $row['color'];?>" ><br>
                <select name="modelo">
                ...
                <input type="text" class="form-control" placeholder = "ingrese la url" name="img" value="<?php echo $row['img'];?>" ><br>
                <div class="col-sm-offset-1 col-sm-1">
                    <button type="submit" class="btn btn-primary" name="actualizar">crear</button>
                </div>     
            </form>
            <div class="col-md-6">
