...
<body>
    ...
    <header class="header header_style_01">
        ...
        <div class="container col-lg-12" style=" display:flex; ">
         ...
         <div class="col-md-5 col-lg-6">
             ...
             <br><h3>ESCOGE EL COLOR DE TU FUNDA </h3>
                ...
                <button class="btn btn-primary " style="height: 30px; background-color:#FDFD96;"></button><br>
        ...
        <a class="nav-link" href="../../login/login.php"><img src="../../images/carritoxd.png" alt="image" width="30px" height="30px"/></a>
            ...
            <div class="col-md-5 col-lg-6">
                <div class="card">
                    <img class="card-img-top" src="../../uploads/P30_Lite" style = "object-fit:scale-down; " alt="700px" width="700px" height = " 700px "> 
