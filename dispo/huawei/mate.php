     ...
     <div class="container col-lg-12" style=" display:flex; ">
         ...
         <div class="col-md-5 col-lg-6">
            <div>
                ...
                <button class="btn btn-primary " style="height: 30px; background-color:#000080;"></button><br>
                <button class="btn btn-primary " style="height: 30px; background-color:#ADD8E6;"></button>
