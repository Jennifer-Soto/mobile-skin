...
<div class="col-md-5 col-lg-6">
    ...
    <br><h3>ESCOGE EL COLOR DE TU FUNDA </h3>
                ...
                <button class="btn btn-primary " style="height: 30px; background-color:#FF0080;"></button>
                <button class="btn btn-primary " style="height: 30px; background-color:#00853C;"></button><br>
                <button class="btn btn-primary " style="height: 30px; background-color:#0A497B;"></button>
   ...
   <div class="col-md-5 col-lg-6">
       <div class="card">
           <img class="card-img-top" src="../../uploads/poco-x3-pro.webp" style = "object-fit:scale-down; " alt="700px" width="700px" height = " 700px "> 
